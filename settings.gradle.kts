...
include("extension-action-entity")
include("extension-action-event")
include("extension-action-illusion")
include("extension-action-item")
include("extension-action-memory")
include("extension-action-target")
include("extension-anser")
include("extension-property-entity")
...
include("extension-property-common")