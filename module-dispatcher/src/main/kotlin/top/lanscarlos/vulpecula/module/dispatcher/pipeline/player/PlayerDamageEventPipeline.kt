 ...
 * @since 2025/7/29
 */
@AutoRegistered("PlayerDamageEvent")
class PlayerDamageEventPipeline(clazz: Class<*>, config: ConfigurationSection) : VirtualPlayerEventPipeline<EntityDamageEvent>(clazz, config)